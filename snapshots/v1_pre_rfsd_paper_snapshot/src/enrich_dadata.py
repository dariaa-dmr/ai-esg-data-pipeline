...
def enrich_dadata_file(
    ...
    token = get_secret(cfg, "DADATA_TOKEN", "dadata_token.txt", section="api", option="dadata_token")
    secret = get_secret(cfg, "DADATA_SECRET", "dadata_secret.txt", section="api", option="dadata_secret")
